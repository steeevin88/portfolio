...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    description:
      "Static web app made as part of Santa Clara University's Hack for Humanity (2023)\n\nView the Devpost submission",
...
function ProjectModalComponent({
  ...
  isOpen,
  onClose,
}: Project & { isOpen: boolean; onClose: () => void }) {
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <Link
              ...
              className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-md transition duration-300"
            >
              <Github size={20} />
              View on GitHub
            </Link>
...
function ProjectCard({ onOpenModal, ...props }: Project & { onOpenModal: () => void }) {
  return (
    <div className="bg-white shadow-lg rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 relative group">
      <div className="h-64 bg-gray-200 flex items-center justify-center overflow-hidden">
        <Image
          src={props.photoUrl || "/placeholder.svg"}
          alt={props.title}
          width={500}
          height={400}
      ...
      <div className="flex flex-row justify-between p-6">
        ...
        <div>
          <button
            onClick={onOpenModal}
            className="relative overflow-hidden bg-gray-600 text-white px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group/btn"
          >
...
export default function Projects() {
  ...
  return (
    <section
      className="min-h-screen bg-gradient-to-b from-gray-300 to-[#7C909A] py-24 px-4 sm:px-6 lg:px-8"
      id="projects"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {projectsData.map((project, index) => (
            <ProjectCard key={index} {...project} onOpenModal={() => setOpenModalIndex(index)} />
          ))}
        </div>
