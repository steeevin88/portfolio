...
export default function ProjectCard({photoUrl, title, dateInfo, description, repoUrl, technologies} : {photoUrl : string, title : string, dateInfo : string, description : string, repoUrl : string, technologies : string}) {
