  ...
  return (
    <div onClick={() => setFlip(!flip)} className="mx-4 mb-4 cursor-pointer">
      <ReactCardFlip isFlipped={flip} flipDirection="horizontal">
        ...
        {/* Front Side */}
        <div>
          <div className="bg-gray-400 w-[90vw] md:w-[450px] h-[450px] rounded-lg flex flex-col justify-center gap-2 md:gap-6 border-black border-2">
          <div className="flex justify-center align-top px-6 h-64">
            <Image
              src={photoUrl}
              alt="logo"
              width="64"
